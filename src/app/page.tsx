      ...
      <div className="flex flex-1 w-full min-h-[90vh] flex-col items-center justify-center ">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
            Elevate Your Health with <span className="text-app-primary">BetterHealth</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 dark:text-gray-400 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Experience a revolutionary approach to personal wellness. Join us on the journey to a healthier, happier you.
          </p>
